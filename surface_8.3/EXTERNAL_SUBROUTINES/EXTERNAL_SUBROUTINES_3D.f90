...
SUBROUTINE SURFACE_3D(TYPE1, TYPE2, TIMESTEP, &
	...
	!$OMP PARALLEL DO PRIVATE(I),REDUCTION(MAX:MAXX,MAXY), REDUCTION(MIN:MINX,MINY)
        ...
        WRITE(*,*) SURFACE_FLUID%SURFACE_POINTS(:,1)
        ...
        WRITE(*,*) SURFACE_PROPEL%SURFACE_POINTS(:,1)
        ...
        WRITE(*,*) SURFACE_CASE%SURFACE_POINTS(:,1)    
        DEALLOCATE(TEMP_FACE)
    ...
    ELSE IF(TYPE1 == 2) THEN
        ...
        CALL LOADING_COEFFS_SURFACE_STRUCT(1, P_POINT_NUM, P_POINT, 2*P_FACE_NUM, TEMP_FACE, TEMP_LOC, P_RIDGE_GROUP_NUM, P_RIDGE_NUM, P_RIDGE) ! P_CORNER_INDEX,
