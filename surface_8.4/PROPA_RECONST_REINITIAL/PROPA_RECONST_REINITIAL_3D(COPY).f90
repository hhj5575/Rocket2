    ...
    DO ITER=1,SURFACE_FLUID%FACE_DIVIDED_BOUNDARY_NUM
        CALL TEST_BOUNDARY_SMOOTHING(SURFACE_FLUID%SURFACE_POINTS_NUM, SURFACE_FLUID%SURFACE_POINTS, SURFACE_FLUID%SURFACE_FACES_NUM, SURFACE_FLUID%SURFACE_FACES, SURFACE_FLUID%POINT_FACE_CONNECTION_NUM, SURFACE_FLUID%POINT_FACE_CONNECTION, SURFACE_FLUID%SURFACE_INITIAL_EDGE_LENGTH, SURFACE_FLUID%FACE_DIVIDED_BOUNDARY_ARRAY, ITER)
    END DO
    ...
    SUBROUTINE FLUID_SMOOTHING_REMESH(POINT_NUM, POINT, FACE_NUM, FACE, CONNECTION_NUM, CONNECTION, FACE_AREA, EDGE_LENGTH, INITIALPOINT_TYPE, POINT_TYPE, DIVIDED_REGION_NUM, DIVIDED_REGION, DIVIDED_BOUNDARY_NUM, DIVIDED_BOUNDARY)
    IMPLICIT NONE
    INTEGER :: POINT_NUM
    REAL(8) :: POINT(:,:)
    INTEGER :: FACE_NUM
    ...
    CALL MASS_SPRING(POINT_NUM, POINT, FACE_NUM, FACE, CONNECTION_NUM, CONNECTION, INITIALPOINT_TYPE, FACE_AREA, DIVIDED_REGION, DIVIDED_BOUNDARY)
    !DO ITER=1,SURFACE_FLUID%FACE_DIVIDED_REGION_NUM
    ...
    DO ITER=1,DIVIDED_BOUNDARY_NUM
        DO I=1,5 
        CALL TEST_BOUNDARY_SMOOTHING(POINT_NUM, POINT, FACE_NUM, FACE, CONNECTION_NUM, CONNECTION, EDGE_LENGTH, DIVIDED_BOUNDARY, ITER)
        END DO
    END DO
    ...
    DO ITER=1,SURFACE_PROPEL%FACE_DIVIDED_BOUNDARY_NUM
        CALL TEST_BOUNDARY_SMOOTHING(SURFACE_PROPEL%SURFACE_POINTS_NUM, SURFACE_PROPEL%SURFACE_POINTS, SURFACE_PROPEL%SURFACE_FACES_NUM, SURFACE_PROPEL%SURFACE_FACES, SURFACE_PROPEL%POINT_FACE_CONNECTION_NUM, SURFACE_PROPEL%POINT_FACE_CONNECTION, SURFACE_PROPEL%SURFACE_INITIAL_EDGE_LENGTH, SURFACE_PROPEL%FACE_DIVIDED_BOUNDARY_ARRAY, ITER)
    END DO
    ...
    !            CALL TEST_BOUNDARY_SMOOTHING(SURFACE_CASE%SURFACE_POINTS_NUM, SURFACE_CASE%SURFACE_POINTS, SURFACE_CASE%SURFACE_FACES_NUM, SURFACE_CASE%SURFACE_FACES, SURFACE_CASE%POINT_FACE_CONNECTION_NUM, SURFACE_CASE%POINT_FACE_CONNECTION, SURFACE_CASE%SURFACE_INITIAL_EDGE_LENGTH, SURFACE_CASE%FACE_DIVIDED_BOUNDARY_ARRAY, ITER)
    !        END DO
    ...
    SUBROUTINE TEST_BOUNDARY_SMOOTHING(TEMP_POINT_NUM, TEMPPOINT, TEMP_FACE_NUM, TEMPFACE, TEMP_CONNECTION_NUM, TEMP_CONNECTION, TEMP_NEWEDGELENGTH, DIVIDED_BOUNDARY_ARRAY, BOUNDARY_FLAG)
    IMPLICIT NONE
...
write(*,*) 'RESULT_TIMESTEP :', result_timestep
    ...
    SUBROUTINE MASS_SPRING_TYPE(TYP, REGION_FLAG)
    IMPLICIT NONE
    INTEGER :: TYP
    INTEGER, OPTIONAL :: REGION_FLAG
    TYPE(SURFACE_TYPE), POINTER :: SURFACE_CURRENT
    ...
    SUBROUTINE MASS_SPRING(TEMP_POINT_NUM, TEMPPOINT, TEMP_FACE_NUM, TEMPFACE, TEMP_CONNECTION_NUM, TEMP_CONNECTION, TEMPINITIALPOINT_TYPE, TEMP_NEWFACEAREA, DIVIDED_REGION_ARRAY, DIVIDED_BOUNDARY_ARRAY, REGION_FLAG)
    IMPLICIT NONE
    ...
    INTEGER, ALLOCATABLE :: A_INDICES_CG(:,:)
    ...
    DO I = 1,TEMP_POINT_NUM
        IF(POINT_INDEX(I) .NE. 0) THEN
            ...
            !A_CG(POINT_INDEX(I), POINT_INDEX(I)) = 1
            ...
            !A_CG(POINT_INDEX_NUM + POINT_INDEX(I), POINT_INDEX_NUM + POINT_INDEX(I)) = 1
            ...
            !A_CG(2*POINT_INDEX_NUM + POINT_INDEX(I), 2*POINT_INDEX_NUM + POINT_INDEX(I)) = 1
        END IF
    END DO
    
    CALL MASS_SPRING_UPDATE_VELOCITY(TEMP_POINT_NUM, X_N, TEMP_FACE_NUM, TEMPFACE, POINT_INDEX, POINT_INDEX_NUM, POINT_MASS, SPRING_K_E, SPRING_K_D, SPRING_L0, DT/2., A_CG, A_INDICES_CG, B_CG, 1)
    
    CALL CG_SOLVER_SPARSE(A_CG, A_INDICES_CG, B_CG, POINT_INDEX_NUM*3, X_CG)
    !CALL CG_SOLVER(A_CG, B_CG, POINT_INDEX_NUM*3, X_CG)
    ...
    DO I = 1,TEMP_POINT_NUM
        IF(POINT_INDEX(I) .NE. 0) THEN
            ...
            CALL INDEX_SPARSE(A_INDICES_CG, POINT_INDEX_NUM + POINT_INDEX(I), POINT_INDEX_NUM + POINT_INDEX(I), IDX)
            A_CG(POINT_INDEX_NUM + POINT_INDEX(I), IDX) = 1.
            !A_CG(POINT_INDEX_NUM + POINT_INDEX(I), POINT_IN	DEX_NUM + POINT_INDEX(I)) = 1
            CALL INDEX_SPARSE(A_INDICES_CG, 2*POINT_INDEX_NUM + POINT_INDEX(I), 2*POINT_INDEX_NUM + POINT_INDEX(I), IDX)
            A_CG(2*POINT_INDEX_NUM + POINT_INDEX(I), IDX) = 1.
            !A_CG(2*POINT_INDEX_NUM + POINT_INDEX(I), 2*POINT_INDEX_NUM + POINT_INDEX(I)) = 1
        END IF
    ...
    CALL MASS_SPRING_UPDATE_VELOCITY(TEMP_POINT_NUM, X_N, TEMP_FACE_NUM, TEMPFACE, POINT_INDEX, POINT_INDEX_NUM, POINT_MASS, SPRING_K_E, SPRING_K_D, SPRING_L0, DT/2., A_CG, A_INDICES_CG, B_CG, 0, V_N)
    
    CALL MASS_SPRING_UPDATE_VELOCITY(TEMP_POINT_NUM, X_N1, TEMP_FACE_NUM, TEMPFACE, POINT_INDEX, POINT_INDEX_NUM, POINT_MASS, SPRING_K_E, SPRING_K_D, SPRING_L0, DT/2., A_CG, A_INDICES_CG, B_CG, 1)
    ...
    SUBROUTINE MASS_SPRING_UPDATE_VELOCITY(TEMP_POINT_NUM, TEMPPOINT, TEMP_FACE_NUM, TEMPFACE, POINT_INDEX, POINT_INDEX_NUM, POINT_MASS, SPRING_K_E, SPRING_K_D, SPRING_L0, DT, A_CG, A_INDICES_CG, B_CG, TYP, VELOCITY)
    IMPLICIT NONE
                ...
                DO L=1,9
                    DO M=1,9
                        IF(INDICES(L) .NE. 0 .AND. INDICES(M) .NE. 0) THEN
                            ...
                            !A_CG(INDICES(L), INDICES(M)) = A_CG(INDICES(L), INDICES(M)) - UPDATES_ARRAY(L,M)
                        END IF
                    END DO
                END DO
            END IF
