        ...
        IF(C) THEN
            ...
            IF(SURFACE_FLUID%POINT_TYPE(I)==5) THEN
                ...
                ELSE
                    ...
                    DO K=1,3
                        TEMPDIST = SQRT(DOT_PRODUCT(SURFACE_FLUID%SURFACE_POINTS(:,I)-SURFACE_CASE%SURFACE_POINTS(:,SURFACE_CASE%SURFACE_FACES(K,J)),SURFACE_FLUID%SURFACE_POINTS(:,I)-SURFACE_CASE%SURFACE_POINTS(:,SURFACE_CASE%SURFACE_FACES(K,J))))
                        IF(TEMPDIST<DIST) THEN
                            DIST = TEMPDIST
                            IDX = K
                        END IF
                    END DO
                    SURFACE_FLUID%SURFACE_POINTS(:,I) = SURFACE_CASE%SURFACE_POINTS(:,SURFACE_CASE%SURFACE_FACES(IDX,J))
                END IF
