...
!    END SUBROUTINE FIND_INTERFACE_CLUSTER
	...
	!$OMP PARALLEL DO PRIVATE(IMIN,TEMPDIST,POINTDIST,A1,A2,A3,B1,B2,B3,N,C1,C2,C3,ROT1,ROT2,ROT3,INNER1,INNER2,D1,PTONSURF,L1,L2,L3,L1_NORM,L2_NORM,L3_NORM,W1,W2,W3,DIST1,DIST2,DIST3,D2)
        ...
        IMIN = 1
        POINTDIST = SQRT(DOT_PRODUCT(PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(1,RELATED_FACE(I))), PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(1,RELATED_FACE(I)))))
        TEMPDIST = SQRT(DOT_PRODUCT(PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(2,RELATED_FACE(I))), PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(2,RELATED_FACE(I)))))
        IF(TEMPDIST < POINTDIST) THEN
            POINTDIST = TEMPDIST
            IMIN = 2
        END IF
        TEMPDIST = SQRT(DOT_PRODUCT(PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(3,RELATED_FACE(I))), PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(3,RELATED_FACE(I)))))
        IF(TEMPDIST < POINTDIST) THEN
            POINTDIST = TEMPDIST
            IMIN = 3
        END IF
        ...
        IF(IMIN == 1) THEN
            A1(:) = TYP1_POINT(:,TYP1_FACE(1,RELATED_FACE(I)))
            A2(:) = TYP1_POINT(:,TYP1_FACE(2,RELATED_FACE(I)))
            A3(:) = TYP1_POINT(:,TYP1_FACE(3,RELATED_FACE(I)))
            
            B1 = CR_SOURCE(TYP1_FACE(1,RELATED_FACE(I)))
            B2 = CR_SOURCE(TYP1_FACE(2,RELATED_FACE(I)))
            B3 = CR_SOURCE(TYP1_FACE(3,RELATED_FACE(I)))
        ELSEIF(IMIN == 2) THEN
            A1(:) = TYP1_POINT(:,TYP1_FACE(2,RELATED_FACE(I)))
            A2(:) = TYP1_POINT(:,TYP1_FACE(3,RELATED_FACE(I)))
            A3(:) = TYP1_POINT(:,TYP1_FACE(1,RELATED_FACE(I)))
            
            B1 = CR_SOURCE(TYP1_FACE(2,RELATED_FACE(I)))
            B2 = CR_SOURCE(TYP1_FACE(3,RELATED_FACE(I)))
            B3 = CR_SOURCE(TYP1_FACE(1,RELATED_FACE(I)))
        ELSE
            A1(:) = TYP1_POINT(:,TYP1_FACE(3,RELATED_FACE(I)))
            A2(:) = TYP1_POINT(:,TYP1_FACE(1,RELATED_FACE(I)))
            A3(:) = TYP1_POINT(:,TYP1_FACE(2,RELATED_FACE(I)))
            
            B1 = CR_SOURCE(TYP1_FACE(3,RELATED_FACE(I)))
            B2 = CR_SOURCE(TYP1_FACE(1,RELATED_FACE(I)))
            B3 = CR_SOURCE(TYP1_FACE(2,RELATED_FACE(I)))
        END IF
