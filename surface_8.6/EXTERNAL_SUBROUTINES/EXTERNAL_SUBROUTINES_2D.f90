...
!        END IF
    ...
    SUBROUTINE SAVINGDATA_TECPLOT(FILE_NUM)
        ...
        STR = ''
        WRITE(STR, '(A)') './output/surface/tec_data/surface_2d_data_0000000.plt'
        L = LEN_TRIM(STR)
    ...
    SUBROUTINE SAVINGINTERFACE_TECPLOT(FILE_NUM)
        ...
        STR = ''
        WRITE(STR, '(A)') './output/surface/tec_interface/surface_2d_interface_0000000.plt'
        L = LEN_TRIM(STR)
...
!            END DO
   ...
   SUBROUTINE SAVING_SURFACE(FILE_NUM, TYP)
	...
	TYPE(SURFACE_TYPE), POINTER :: SURFACE_CURRENT
        ...
        STR = './output/surface/restart/mesh_num_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
	...
	WRITE(21,*) INTERFACE_STRUCT_POINTS_NUM
        ...
        STR = './output/surface/restart/point_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_velocity_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_displacement_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_force_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_edge_connection_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_type_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_relatedpt_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/point_relatededge_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_POINTS_NUM
        ...
        STR = './output/surface/restart/edge_b_rate_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        CLOSE(21)
         ...
         STR = './output/surface/restart/initial_edge_length_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        STR = './output/surface/restart/edge_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        STR = './output/surface/restart/edge_location_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        STR = './output/surface/restart/edge_oninterface_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        STR = './output/surface/restart/edge_pressure_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
            WRITE(21,*) SURFACE_CURRENT%EDGE_PRESSURE(I)
        ...
        STR = './output/surface/restart/edge_impact_zone_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        STR = './output/surface/restart/edge_ablation_flag_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, SURFACE_CURRENT%SURFACE_EDGES_NUM
        ...
        STR = './output/surface/restart/topchange_typ_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        ...
        STR = './output/surface/restart/interface_fluid_points_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        ...
        STR = './output/surface/restart/interface_fluid_points_loc_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, INTERFACE_FLUID_POINTS_NUM
        ...
        STR = './output/surface/restart/interface_struct_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        ...
        STR = './output/surface/restart/interface_struct_points_loc_2d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
        OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
        !$OMP DO ORDERED 
        DO I = 1, INTERFACE_STRUCT_POINTS_NUM
