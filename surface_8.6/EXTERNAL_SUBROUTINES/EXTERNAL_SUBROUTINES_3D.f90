MODULE SURFACE_EXTERNAL_COMMON_3D
	...
	IMPLICIT NONE
        ...
        STR = ''
        WRITE(STR, '(A)') './output/surface/tec_data/surface_3d_data_0000000.plt'
        L = LEN_TRIM(STR)
	    ...
	    !$OMP END DO
            ...
            END DO
	    !$OMP END DO
            !$OMP DO ORDERED PRIVATE(F_SHAPE, F_SIZE,F_SIZE_SHAPE)
            DO I = 1, SURFACE_CURRENT%SURFACE_FACES_NUM
    ...
    SUBROUTINE SAVINGINTERFACE_TECPLOT(FILE_NUM)
        ...
        STR = ''
        WRITE(STR, '(A)') './output/surface/tec_interface/surface_3d_interface_0000000.plt'
        L = LEN_TRIM(STR)
    ...
    SUBROUTINE SAVINGBRATE(FILE_NUM, TYP)
        ...
        WRITE(STR, *), FILE_NUM
        STR = './output/surface/brates_3d/brates' // TRIM(ADJUSTL(STR)) // '.txt'
        WRITE(*,*) TRIM(STR)
    ...
    STR = './output/surface/restart/surface_restart_3d' // TRIM(ADJUSTL(STR1)) // '_' // TRIM(ADJUSTL(STR2)) // '.txt'
    OPEN(UNIT=21, FILE = STR, ACTION = "WRITE", STATUS = "REPLACE")
...
SUBROUTINE SURFACE_3D(TYPE1, TYPE2, TIMESTEP, &
	...
	!$OMP PARALLEL DO PRIVATE(I),REDUCTION(MAX:MAXX,MAXY), REDUCTION(MIN:MINX,MINY)
        ...
        WRITE(*,*) 'FLUID_SURFACE : FINISH LOADING POINT, FACE INFO'        
        ...
        WRITE(*,*) 'PROPEL_SURFACE : FINISH LOADING POINT, FACE INFO'
        ...
        WRITE(*,*) 'CASE_SURFACE : FINISH LOADING POINT, FACE INFO' 
        DEALLOCATE(TEMP_FACE)
        
        CALL FIND_INTERFACE_FLUID()
!        CALL FIND_INTERFACE(0,2)
        WRITE(*,*) 'FIND INTERFACE : FLUID FINISHED' 
        CALL FIND_INTERFACE_PROPEL()
!        CALL FIND_INTERFACE(1,2)
        WRITE(*,*) 'FIND INTERFACE : PROPEL FINISHED' 
        CALL FIND_INTERFACE(2,2)
        WRITE(*,*) 'FIND INTERFACE : CASE FINISHED'
        
        CALL FIND_REGION_BOUNDARY(0)
        WRITE(*,*) 'BOUNDARY,REGION SETTING : FLUID FINISHED' 
        
        CALL FIND_REGION_BOUNDARY(1)
        WRITE(*,*) 'BOUNDARY,REGION SETTING : PROPEL FINISHED'
        
        CALL FIND_REGION_BOUNDARY(2)
        WRITE(*,*) 'BOUNDARY,REGION SETTING : CASE FINISHED'
        ...
        WRITE(*,*) 'RELATEDPT SETTING : PROPEL-FLUID FINISHED'
        CALL FIND_RELATEDPT(2,1,MAX(DOMAIN_MAX(1) - DOMAIN_MIN(1), DOMAIN_MAX(2) - DOMAIN_MIN(2), DOMAIN_MAX(3) - DOMAIN_MIN(3)),1)
        WRITE(*,*) 'RELATEDPT SETTING : CASE-PROPEL FINISHED'
        
        CALL FIND_RELATEDFACE(0,2,.FALSE.,1)
        WRITE(*,*) 'RELATEDFACE SETTING : FLUID-CASE FINISHED'
        CALL FIND_RELATEDFACE(1,0,.FALSE.,1)
        WRITE(*,*) 'RELATEDFACE SETTING : PROPEL-FLUID FINISHED'
        !CALL FIND_RELATEDFACE(1,2,.FALSE.,1)
        CALL FIND_RELATEDFACE(2,0,.FALSE.,1)
        WRITE(*,*) 'RELATEDFACE SETTING : CASE-FLUID FINISHED'
        
        CALL FIND_IMPACT_ZONE(0,0)
        WRITE(*,*) 'IMPACT_ZONE SETTING : FLUID-FLUID FINISHED'
        !CALL FIND_IMPACT_ZONE(0,2)
        CALL FIND_IMPACT_ZONE(1,1)
        WRITE(*,*) 'IMPACT_ZONE SETTING : PROPEL-PROPEL FINISHED'
        ...
        WRITE(*,*) 'INTERFACE_CLUSTER : FLUID FINISHED'
        CALL FIND_INTERFACE_CLUSTER(1)
        WRITE(*,*) 'INTERFACE_CLUSTER : STRUCT FINISHED'
        
        CALL FIND_INTERFACE_RELATEDFACE(0)
        CALL FIND_INTERFACE_RELATEDFACE(1)
...
!                ZIPPER_FLAG = 1
    ...
    ELSE IF(TYPE1==1) THEN
        ...
        IF(TYPE2==0) THEN
            ...
            write(*,*) 'case_1242_before_moving:'
	    write(*,*) surface_case%surface_points(:,1242)
            !$OMP PARALLEL DO PRIVATE(I)
            DO I = 1, SURFACE_PROPEL%SURFACE_POINTS_NUM
...
write(*,*) 'case_1242_after_moving:'
	    ...
	    END IF
            TEMPFLAG = .FALSE.
            IF(.NOT. FLAG) THEN
		!$OMP PARALLEL DO SHARED(TEMPFLAG)
    ...
    ELSE IF(TYPE1 == 2) THEN
        ...
        CALL LOADING_COEFFS_SURFACE_STRUCT(1, P_POINT_NUM, P_POINT, 2*P_FACE_NUM, TEMP_FACE, TEMP_LOC, P_RIDGE_GROUP_NUM, P_RIDGE_NUM, P_RIDGE)
    ...
    ELSE IF(TYPE1==50) THEN
        ...
        WRITE(*,*) 'TOPOLOGICAL CHANGE TEST'
        
        CALL TEST_ZIPPER(1, B)
    
        WRITE(*,*) 'TOPOLOGICAL CHANGE TEST ENDED'
