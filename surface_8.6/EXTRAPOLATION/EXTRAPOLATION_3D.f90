...
!    END SUBROUTINE FIND_INTERFACE_CLUSTER
    ...
    SUBROUTINE FIND_INTERFACE_RELATEDFACE(TYP)
        IMPLICIT NONE
        INTEGER :: TYP
        
        IF(TYP==0) THEN
        
        IF(ALLOCATED(INTERFACE_FLUID_POINT_RELATEDFACE)) THEN
            DEALLOCATE(INTERFACE_FLUID_POINT_RELATEDFACE)
        END IF
        
        IF(ALLOCATED(INTERFACE_FLUID_FACE_RELATEDFACE)) THEN
            DEALLOCATE(INTERFACE_FLUID_FACE_RELATEDFACE)
        END IF
        
        ALLOCATE(INTERFACE_FLUID_POINT_RELATEDFACE(INTERFACE_FLUID_POINTS_NUM))
        ALLOCATE(INTERFACE_FLUID_FACE_RELATEDFACE(INTERFACE_FLUID_FACES_NUM))
        
        CALL FIND_POINT_FACE_RELATEDFACE_INTERFACE(0, INTERFACE_FLUID_POINTS_NUM, INTERFACE_FLUID_POINTS, INTERFACE_FLUID_FACES_NUM, INTERFACE_FLUID_FACES, INTERFACE_STRUCT_POINTS_NUM, INTERFACE_STRUCT_POINTS, INTERFACE_STRUCT_FACES_NUM, INTERFACE_STRUCT_FACES, INTERFACE_FLUID_POINT_RELATEDFACE, INTERFACE_FLUID_FACE_RELATEDFACE)
        
        ELSE
        
        IF(ALLOCATED(INTERFACE_STRUCT_POINT_RELATEDFACE)) THEN
            DEALLOCATE(INTERFACE_STRUCT_POINT_RELATEDFACE)
        END IF
        
        IF(ALLOCATED(INTERFACE_STRUCT_FACE_RELATEDFACE)) THEN
            DEALLOCATE(INTERFACE_STRUCT_FACE_RELATEDFACE)
        END IF
        
        ALLOCATE(INTERFACE_STRUCT_POINT_RELATEDFACE(INTERFACE_STRUCT_POINTS_NUM))
        ALLOCATE(INTERFACE_STRUCT_FACE_RELATEDFACE(INTERFACE_STRUCT_FACES_NUM/2))
        
        CALL FIND_POINT_FACE_RELATEDFACE_INTERFACE(1, INTERFACE_STRUCT_POINTS_NUM, INTERFACE_STRUCT_POINTS, INTERFACE_STRUCT_FACES_NUM, INTERFACE_STRUCT_FACES, INTERFACE_FLUID_POINTS_NUM, INTERFACE_FLUID_POINTS, INTERFACE_FLUID_FACES_NUM, INTERFACE_FLUID_FACES, INTERFACE_STRUCT_POINT_RELATEDFACE, INTERFACE_STRUCT_FACE_RELATEDFACE)
        
        END IF
    
    END SUBROUTINE
    
    SUBROUTINE UPDATE_INTERFACE_RELATEDFACE(TYP)
        IMPLICIT NONE
        INTEGER :: TYP
        
        IF(TYP==0) THEN
        
        CALL UPDATE_POINT_FACE_RELATEDFACE_INTERFACE(0, INTERFACE_FLUID_POINTS_NUM, INTERFACE_FLUID_POINTS, INTERFACE_FLUID_FACES_NUM, INTERFACE_FLUID_FACES, INTERFACE_STRUCT_POINTS_NUM, INTERFACE_STRUCT_POINTS, INTERFACE_STRUCT_FACES_NUM, INTERFACE_STRUCT_FACES, INTERFACE_FLUID_POINT_RELATEDFACE, INTERFACE_FLUID_FACE_RELATEDFACE)
        
        ELSE
        
        CALL UPDATE_POINT_FACE_RELATEDFACE_INTERFACE(1, INTERFACE_STRUCT_POINTS_NUM, INTERFACE_STRUCT_POINTS, INTERFACE_STRUCT_FACES_NUM, INTERFACE_STRUCT_FACES, INTERFACE_FLUID_POINTS_NUM, INTERFACE_FLUID_POINTS, INTERFACE_FLUID_FACES_NUM, INTERFACE_FLUID_FACES, INTERFACE_STRUCT_POINT_RELATEDFACE, INTERFACE_STRUCT_FACE_RELATEDFACE)
    ...
    SUBROUTINE EXTRAPOLATION_COMMON_REFINEMENT(TYP1, TYP2, DATA1, DATA2, TARGET1, TARGET2, FLAG1, FLAG2)
	IMPLICIT NONE
        INTEGER :: TYP1, TYP2
        ...
        INTEGER, POINTER, DIMENSION(:) :: TYP2_POINT_RELATEDFACE
        INTEGER, POINTER, DIMENSION(:) :: TYP2_FACE_RELATEDFACE
        
        REAL(8) :: DATA1(:), DATA2(:), TARGET1(:), TARGET2(:)
        
        INTEGER, OPTIONAL :: FLAG1, FLAG2
        
        INTEGER, ALLOCATABLE :: TYP1_CONNECTION_NUM(:), TYP1_CONNECTION(:,:), TYP1_POINT_TYPE(:)
	...
	!$OMP PARALLEL DO PRIVATE(I)
        ...
        IF(PRESENT(FLAG1)) THEN
        
        ALLOCATE(TYP1_CONNECTION_NUM(TYP1_POINT_NUM), TYP1_CONNECTION(30,TYP1_POINT_NUM), TYP1_POINT_TYPE(TYP1_POINT_NUM))
        TYP1_CONNECTION_NUM(:) = 0
        TYP1_CONNECTION(:,:) = 0
        TYP1_POINT_TYPE(:) = 0
        
        CALL POINT_FACE_CONNECTING(TYP1_POINT_NUM, TYP1_FACE_NUM, TYP1_FACE, TYP1_CONNECTION_NUM, TYP1_CONNECTION)
        
        DO I=1,TYP1_POINT_NUM
            IF(TYP1_POINTLOC(2,I)==0) THEN
                TYP1_POINT_TYPE(I) = SURFACE_FLUID%POINT_TYPE(TYP1_POINTLOC(1,I))
            ELSE IF(TYP1_POINTLOC(2,I)==1) THEN
                TYP1_POINT_TYPE(I) = SURFACE_PROPEL%POINT_TYPE(TYP1_POINTLOC(1,I))
            ELSE
                TYP1_POINT_TYPE(I) = SURFACE_CASE%POINT_TYPE(TYP1_POINTLOC(1,I))
            END IF
        END DO
        
        IF (TYP2==0) THEN
            TYP2_POINT_RELATEDFACE => INTERFACE_FLUID_POINT_RELATEDFACE
            TYP2_FACE_RELATEDFACE => INTERFACE_FLUID_FACE_RELATEDFACE
        ELSE
            TYP2_POINT_RELATEDFACE => INTERFACE_STRUCT_POINT_RELATEDFACE
            TYP2_FACE_RELATEDFACE => INTERFACE_STRUCT_FACE_RELATEDFACE
        END IF
        
        IF(TYP2==1 .AND. FLAG2==2) THEN
            FLAG2 = 3
        END IF
        
        CALL DATA_TRANSFER_CUBIC(FLAG1, TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, FLAG2, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, TYP2_POINT_RELATEDFACE, TYP2_FACE_RELATEDFACE, CR_SOURCE, CR_TARGET)
        
        DEALLOCATE(TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE)
    ...
    SUBROUTINE FIND_RELATEDFACE_INTERFACE(TYP1_POINT_NUM, TYP1_POINT, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, RELATEDFACE, PROJECTION_POINT)
        IMPLICIT NONE
    ...
    END SUBROUTINE FIND_RELATEDFACE_INTERFACE
	...
	IMPLICIT NONE
        ...
        INTEGER, ALLOCATABLE :: RELATEDFACE(:)
        ...
        ALLOCATE(RELATEDFACE(TYP2_POINT_NUM))
        
        PROJECTION_POINT(:,:) = 0.
        RELATEDFACE(:) = 0.
        
        CALL FIND_RELATEDFACE_INTERFACE(TYP2_POINT_NUM, TYP2_POINT, TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, RELATEDFACE, PROJECTION_POINT)

	!$OMP PARALLEL DO PRIVATE(IMIN,TEMPDIST,POINTDIST,A1,A2,A3,B1,B2,B3,N,C1,C2,C3,ROT1,ROT2,ROT3,INNER1,INNER2,D1,PTONSURF,L1,L2,L3,L1_NORM,L2_NORM,L3_NORM,W1,W2,W3,DIST1,DIST2,DIST3,D2)
        
        DO I=1,TYP2_POINT_NUM

        IMIN = 1
        POINTDIST = SQRT(DOT_PRODUCT(PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(1,RELATEDFACE(I))), PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(1,RELATEDFACE(I)))))
        TEMPDIST = SQRT(DOT_PRODUCT(PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(2,RELATEDFACE(I))), PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(2,RELATEDFACE(I)))))
        IF(TEMPDIST < POINTDIST) THEN
            POINTDIST = TEMPDIST
            IMIN = 2
        END IF
        TEMPDIST = SQRT(DOT_PRODUCT(PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(3,RELATEDFACE(I))), PROJECTION_POINT(:,I)-TYP1_POINT(:,TYP1_FACE(3,RELATEDFACE(I)))))
        IF(TEMPDIST < POINTDIST) THEN
            POINTDIST = TEMPDIST
            IMIN = 3
        END IF
        ...
        IF(IMIN == 1) THEN
            A1(:) = TYP1_POINT(:,TYP1_FACE(1,RELATEDFACE(I)))
            A2(:) = TYP1_POINT(:,TYP1_FACE(2,RELATEDFACE(I)))
            A3(:) = TYP1_POINT(:,TYP1_FACE(3,RELATEDFACE(I)))
            
            B1 = CR_SOURCE(TYP1_FACE(1,RELATEDFACE(I)))
            B2 = CR_SOURCE(TYP1_FACE(2,RELATEDFACE(I)))
            B3 = CR_SOURCE(TYP1_FACE(3,RELATEDFACE(I)))
        ELSEIF(IMIN == 2) THEN
            A1(:) = TYP1_POINT(:,TYP1_FACE(2,RELATEDFACE(I)))
            A2(:) = TYP1_POINT(:,TYP1_FACE(3,RELATEDFACE(I)))
            A3(:) = TYP1_POINT(:,TYP1_FACE(1,RELATEDFACE(I)))
            
            B1 = CR_SOURCE(TYP1_FACE(2,RELATEDFACE(I)))
            B2 = CR_SOURCE(TYP1_FACE(3,RELATEDFACE(I)))
            B3 = CR_SOURCE(TYP1_FACE(1,RELATEDFACE(I)))
        ELSE
            A1(:) = TYP1_POINT(:,TYP1_FACE(3,RELATEDFACE(I)))
            A2(:) = TYP1_POINT(:,TYP1_FACE(1,RELATEDFACE(I)))
            A3(:) = TYP1_POINT(:,TYP1_FACE(2,RELATEDFACE(I)))
            
            B1 = CR_SOURCE(TYP1_FACE(3,RELATEDFACE(I)))
            B2 = CR_SOURCE(TYP1_FACE(1,RELATEDFACE(I)))
            B3 = CR_SOURCE(TYP1_FACE(2,RELATEDFACE(I)))
        END IF
        
        CALL VEC_CURL2(A1,A2,A1,A3,N)
    
        CALL VEC_CURL2(PROJECTION_POINT(:,I),A1,A2,A1,C1)
        CALL VEC_CURL2(PROJECTION_POINT(:,I),A2,A3,A2,C2)
        CALL VEC_CURL2(PROJECTION_POINT(:,I),A3,A1,A3,C3)
        
        ROT1 = DOT_PRODUCT(C1,N)
        ROT2 = DOT_PRODUCT(C2,N)
        ROT3 = DOT_PRODUCT(C3,N)
        
        INNER1 = DOT_PRODUCT(A1-PROJECTION_POINT(:,I), A2-A1)
        INNER2 = DOT_PRODUCT(A1-PROJECTION_POINT(:,I), A3-A1)
        ...
        ELSE IF(ROT1<0 .AND. ROT2<0 .AND. ROT3<0) THEN
            ...
            D1 = DOT_PRODUCT(PROJECTION_POINT(:,I)-A1,N)
            
            PTONSURF = PROJECTION_POINT(:,I) - D1*N
            ...
            CR_TARGET(I) = W1*B1 + W2*B2 + W3*B3
        ELSE
            CALL UNSIGNED_DISTANCE_EDGE_POINT(PROJECTION_POINT(:,I),A1,A2,DIST1)
            CALL UNSIGNED_DISTANCE_EDGE_POINT(PROJECTION_POINT(:,I),A1,A3,DIST2)
            CALL UNSIGNED_DISTANCE_EDGE_POINT(PROJECTION_POINT(:,I),A2,A3,DIST3)
	    TEMPDIST = MIN(DIST1,DIST2,DIST3)
            IF(TEMPDIST==DIST1) THEN
                D1 = DOT_PRODUCT(A2-A1,A2-PROJECTION_POINT(:,I))
                D2 = DOT_PRODUCT(A2-A1,A2-A1)
                W1 = D1/D2
                D1 = DOT_PRODUCT(A1-A2,A1-PROJECTION_POINT(:,I))
                W2 = D1/D2
                
                CR_TARGET(I) = W1*B1 + W2*B2
            ELSE IF(TEMPDIST==DIST2) THEN
                D1 = DOT_PRODUCT(A3-A1,A3-PROJECTION_POINT(:,I))
                D2 = DOT_PRODUCT(A3-A1,A3-A1)
                W1 = D1/D2
                D1 = DOT_PRODUCT(A1-A3,A1-PROJECTION_POINT(:,I))
                W3 = D1/D2
                
                CR_TARGET(I) = W1*B1 + W3*B3
            ELSE
                D1 = DOT_PRODUCT(A3-A2,A3-PROJECTION_POINT(:,I))
                D2 = DOT_PRODUCT(A3-A2,A3-A2)
                W2 = D1/D2
                D1 = DOT_PRODUCT(A2-A3,A2-PROJECTION_POINT(:,I))
                W3 = D1/D2
                
                CR_TARGET(I) = W2*B2 + W3*B3
            END IF
        END IF	    
            !CALL INTERPOLATION_ONE_FACE(PROJECTION_POINT(:,I), TYP1_POINT(:,TYP1_FACE(1,RELATEDFACE(I))), TYP1_POINT(:,TYP1_FACE(2,RELATEDFACE(I))), TYP1_POINT(:,TYP1_FACE(3,RELATEDFACE(I))), CR_SOURCE(TYP1_FACE(1,RELATEDFACE(I))), CR_SOURCE(TYP1_FACE(2,RELATEDFACE(I))), CR_SOURCE(TYP1_FACE(3,RELATEDFACE(I))), CR_TARGET(I))
        END DO
        !$OMP END PARALLEL DO

        DEALLOCATE(RELATEDFACE)
        DEALLOCATE(PROJECTION_POINT)
        
    END SUBROUTINE DATA_TRANSFER_WITHOUT_CR
    
    SUBROUTINE FIND_POINT_FACE_RELATEDFACE_INTERFACE(TYP1, TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, POINT_RELATEDFACE, FACE_RELATEDFACE)
        IMPLICIT NONE
        ...
        INTEGER :: POINT_RELATEDFACE(:)
        INTEGER :: FACE_RELATEDFACE(:)
        ...
        DO I=1,TYP1_POINT_NUM
            CALL RELATE_INTERFACE_POINT_HASH(TYP1_POINT(:,I), TYP2_POINT, TYP2_FACE, HASH0,  IDX)
            POINT_RELATEDFACE(I) = IDX
        END DO
        
        IF(TYP1==0) THEN
        
        DO I=1,TYP1_FACE_NUM
            V = ( TYP1_POINT(:,TYP1_FACE(1,I)) + TYP1_POINT(:,TYP1_FACE(2,I)) + TYP1_POINT(:,TYP1_FACE(3,I)) )/3.
            CALL RELATE_INTERFACE_POINT_HASH(V, TYP2_POINT, TYP2_FACE, HASH0,  IDX)
            FACE_RELATEDFACE(I) = IDX
        END DO
        
        ELSE IF(TYP1==1) THEN
        
        DO I=1,TYP1_FACE_NUM/2
            V = ( TYP1_POINT(:,TYP1_FACE(1,2*I-1)) + TYP1_POINT(:,TYP1_FACE(2,2*I-1)) + TYP1_POINT(:,TYP1_FACE(3,2*I-1)) + TYP1_POINT(:,TYP1_FACE(3,2*I)) )/4.
            CALL RELATE_INTERFACE_POINT_HASH(V, TYP2_POINT, TYP2_FACE, HASH0,  IDX)
            FACE_RELATEDFACE(I) = IDX
        END DO
    ...
    END SUBROUTINE FIND_POINT_FACE_RELATEDFACE_INTERFACE
    
    SUBROUTINE RELATE_INTERFACE_POINT_NEIGHBOR(V, POINT, FACE, CONNECTION_NUM, CONNECTION, IDX0,  IDX, V_RET)
        IMPLICIT NONE
        REAL(8) :: V(3)
        REAL(8) :: POINT(:,:)
        INTEGER :: FACE(:,:)
        ...
        R =  MAX(DOMAIN_MAX(1) - DOMAIN_MIN(1), DOMAIN_MAX(2) - DOMAIN_MIN(2), DOMAIN_MAX(3) - DOMAIN_MIN(3))
        DO K=1,3
            DO L=1,CONNECTION_NUM(FACE(K,IDX0))
                I0 = CONNECTION(L,FACE(K,IDX0))
    ...
    END SUBROUTINE RELATE_INTERFACE_POINT_NEIGHBOR
    
    SUBROUTINE UPDATE_POINT_FACE_RELATEDFACE_INTERFACE(TYP1, TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, POINT_RELATEDFACE, FACE_RELATEDFACE)
        IMPLICIT NONE
        ...
        INTEGER, ALLOCATABLE :: TYP2_CONNECTION_NUM(:), TYP2_CONNECTION(:,:)
        
        INTEGER :: I, IDX0, IDX
        
        REAL(8) :: V(3)
        
        ALLOCATE(TYP2_CONNECTION_NUM(TYP2_POINT_NUM), TYP2_CONNECTION(30,TYP2_POINT_NUM))
        TYP2_CONNECTION_NUM(:) = 0
        TYP2_CONNECTION(:,:) = 0
        
        CALL POINT_FACE_CONNECTING(TYP2_POINT_NUM, TYP2_FACE_NUM, TYP2_FACE, TYP2_CONNECTION_NUM, TYP2_CONNECTION)
        
        DO I=1,TYP1_POINT_NUM
            IDX0 = POINT_RELATEDFACE(I)
            CALL RELATE_INTERFACE_POINT_NEIGHBOR(TYP1_POINT(:,I), TYP2_POINT, TYP2_FACE, TYP2_CONNECTION_NUM, TYP2_CONNECTION, IDX0,  IDX)
            POINT_RELATEDFACE(I) = IDX
        END DO
        ...
        DO I=1,TYP1_FACE_NUM
            IDX0 = FACE_RELATEDFACE(I)
            V = ( TYP1_POINT(:,TYP1_FACE(1,I)) + TYP1_POINT(:,TYP1_FACE(2,I)) + TYP1_POINT(:,TYP1_FACE(3,I)) )/3.
            CALL RELATE_INTERFACE_POINT_NEIGHBOR(V, TYP2_POINT, TYP2_FACE, TYP2_CONNECTION_NUM, TYP2_CONNECTION, IDX0,  IDX)
            FACE_RELATEDFACE(I) = IDX
        END DO
        ...
        DEALLOCATE(TYP2_CONNECTION_NUM, TYP2_CONNECTION)
        
    END SUBROUTINE UPDATE_POINT_FACE_RELATEDFACE_INTERFACE
    
    
    SUBROUTINE DATA_TRANSFER_CUBIC(FLAG1, TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, FLAG2, TYP2_POINT_NUM, TYP2_POINT, TYP2_FACE_NUM, TYP2_FACE, TYP2_POINT_RELATEDFACE, TYP2_FACE_RELATEDFACE, CR_SOURCE, CR_TARGET)
	IMPLICIT NONE
        ...
        INTEGER :: TYP1_CONNECTION_NUM(:)
        INTEGER :: TYP1_CONNECTION(:,:)
        INTEGER :: TYP1_POINT_TYPE(:)
        ...
        INTEGER :: TYP2_POINT_RELATEDFACE(:)
        INTEGER :: TYP2_FACE_RELATEDFACE(:)
        ...
        DO I=1,TYP2_POINT_NUM
            IF(FLAG1==1) THEN
            CALL HIGH_ORDER_INTERPOLATION_POINT(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE, TYP2_POINT_RELATEDFACE(I), CR_SOURCE, TYP2_POINT(:,I), 3, 2, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, CR_TARGET(I))
            ELSE IF(FLAG1==2) THEN
            CALL HIGH_ORDER_INTERPOLATION_FACE(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP2_POINT_RELATEDFACE(I), CR_SOURCE, TYP2_POINT(:,I), 3, 2, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, CR_TARGET(I))
            END IF
        END DO
        ...
        DO I=1,TYP2_FACE_NUM
            V = ( TYP2_POINT(:,TYP2_FACE(1,I)) + TYP2_POINT(:,TYP2_FACE(2,I)) + TYP2_POINT(:,TYP2_FACE(3,I)) )/3.
            
            IF(FLAG1==1) THEN
            CALL HIGH_ORDER_INTERPOLATION_POINT(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE, TYP2_FACE_RELATEDFACE(I), CR_SOURCE, V, 3, 2, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, CR_TARGET(I))
            ELSE IF(FLAG1==2) THEN
            CALL HIGH_ORDER_INTERPOLATION_FACE(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP2_FACE_RELATEDFACE(I), CR_SOURCE, V, 3, 2, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, CR_TARGET(I))
            END IF
        END DO
        
        ELSE IF(FLAG2==3) THEN
        
        DO I=1,TYP2_FACE_NUM/2
            V = ( TYP2_POINT(:,TYP2_FACE(1,2*I-1)) + TYP2_POINT(:,TYP2_FACE(2,2*I-1)) + TYP2_POINT(:,TYP2_FACE(3,2*I-1)) + TYP2_POINT(:,TYP2_FACE(3,2*I)) )/4.
            
            IF(FLAG1==1) THEN
            CALL HIGH_ORDER_INTERPOLATION_POINT(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE, TYP2_FACE_RELATEDFACE(I), CR_SOURCE, V, 3, 2, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, CR_TARGET(2*I-1))
            ELSE IF(FLAG1==2) THEN
            CALL HIGH_ORDER_INTERPOLATION_FACE(TYP1_POINT_NUM, TYP1_POINT, TYP1_FACE_NUM, TYP1_FACE, TYP2_FACE_RELATEDFACE(I), CR_SOURCE, V, 3, 2, TYP1_CONNECTION_NUM, TYP1_CONNECTION, TYP1_POINT_TYPE, CR_TARGET(2*I-1))
            END IF
            
            CR_TARGET(2*I) = CR_TARGET(2*I-1)
        END DO
        
        END IF
        
    END SUBROUTINE DATA_TRANSFER_CUBIC
