MODULE SURFACE_MODULE_3D
    ...
    INTEGER, ALLOCATABLE, TARGET :: INTERFACE_FLUID_POINT_RELATEDFACE(:)
    INTEGER, ALLOCATABLE, TARGET :: INTERFACE_FLUID_FACE_RELATEDFACE(:)
    ...
    INTEGER, ALLOCATABLE, TARGET :: INTERFACE_STRUCT_POINT_RELATEDFACE(:)
    INTEGER, ALLOCATABLE, TARGET :: INTERFACE_STRUCT_FACE_RELATEDFACE(:)
